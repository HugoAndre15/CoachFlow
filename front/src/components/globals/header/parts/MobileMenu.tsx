        ...
        <div className="pt-3 border-t border-neutral/20 dark:border-dark-light space-y-1">
          {user ? (
            <>
              ...
              <a href="/dashboard/teams" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-dark-light dark:text-neutral-lighter hover:bg-neutral-lighter/50 dark:hover:bg-dark-light/50 hover:text-dark dark:hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-dark-light/70 dark:text-neutral">
